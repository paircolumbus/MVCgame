  ...
  module Print
    class << self
      ...
      def display(body)
        ...
        fail NotInitialized, 'Please run the initialization before attempting display' unless @@initilized
      ...
      def checkContent(header, body, footer)
        ...
        fail TooMuchContent 'Reduce line size...' unless content.first.length < (@screen_size - 6)
